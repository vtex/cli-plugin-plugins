...
_See code: [src/commands/plugins/install.ts](https://github.com/vtex/cli-plugin-plugins/blob/v1.11.1-beta/src/commands/plugins/install.ts)_
...
_See code: [src/commands/plugins/link.ts](https://github.com/vtex/cli-plugin-plugins/blob/v1.11.1-beta/src/commands/plugins/link.ts)_
...
_See code: [src/commands/plugins/list.ts](https://github.com/vtex/cli-plugin-plugins/blob/v1.11.1-beta/src/commands/plugins/list.ts)_
...
_See code: [src/commands/plugins/source.ts](https://github.com/vtex/cli-plugin-plugins/blob/v1.11.1-beta/src/commands/plugins/source.ts)_
...
_See code: [src/commands/plugins/uninstall.ts](https://github.com/vtex/cli-plugin-plugins/blob/v1.11.1-beta/src/commands/plugins/uninstall.ts)_
...
_See code: [src/commands/plugins/update.ts](https://github.com/vtex/cli-plugin-plugins/blob/v1.11.1-beta/src/commands/plugins/update.ts)_
<!-- commandsstop -->
